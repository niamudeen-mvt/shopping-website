  ...
  return (
    <>
      ...
      <Box className="common_margin">
        <CommonContainer maxWidth="lg" className="common_section_height">
          <Grid container spacing={10}>
            <Grid xs={12} md={6} item>
              <Box maxWidth={'588px'} >
                <img src={productImg} alt="drop-collection-img1" />
              </Box>
            </Grid>
            <Grid xs={12} md={6} item>
              <Box>
                <CommonContentSecion heading={`The Drops, We Craft Awesome With  Great Experiences.`} subheading="The Drops is an online retailer that offers top quality products at competitive prices. we offer Free Fast Worldwide Shipping to all customers. " btnColor="#4175BD" btnText={"Contact Us"} />
              </Box>
            </Grid>
          </Grid>
        </CommonContainer>
      ...
      <CustomContentBar
        ...
        subheading={'Use our Code Shop15 for 15 percent off your order. $50 or more '}
        btnText="Shop Now"
        btncolor="#4175BD"
        contentbarImg={contentbarImg}
      />
      <CustomSocial heading={'Check us out'} socialIconList={socialIconList} />
